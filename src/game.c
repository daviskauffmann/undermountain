...
struct game *game_create(void)
{
    ...
    game->base_item_info[BASE_ITEM_BATTLEAXE].armor_class = 0;
    ...
    game->base_item_info[BASE_ITEM_CLUB].armor_class = 0;
    ...
    game->base_item_info[BASE_ITEM_DAGGER].armor_class = 0;
    ...
    game->base_item_info[BASE_ITEM_GREATAXE].armor_class = 0;
    ...
    game->base_item_info[BASE_ITEM_GREATSWORD].armor_class = 0;
    ...
    game->base_item_info[BASE_ITEM_HALBERD].armor_class = 0;
    ...
    game->base_item_info[BASE_ITEM_HEAVY_CROSSBOW].armor_class = 0;
    ...
    game->base_item_info[BASE_ITEM_KATANA].armor_class = 0;
    ...
    game->base_item_info[BASE_ITEM_LIGHT_CROSSBOW].armor_class = 0;
    ...
    game->base_item_info[BASE_ITEM_MACE].armor_class = 0;
    ...
    game->base_item_info[BASE_ITEM_QUARTERSTAFF].armor_class = 0;
    ...
    game->base_item_info[BASE_ITEM_SCIMITAR].armor_class = 0;
    ...
    game->base_item_info[BASE_ITEM_SHORTBOW].armor_class = 0;
    ...
    game->base_item_info[BASE_ITEM_SHORTSWORD].armor_class = 0;
    ...
    game->base_item_info[BASE_ITEM_SPEAR].armor_class = 0;
    ...
    game->base_item_info[BASE_ITEM_WARHAMMER].armor_class = 0;
