...
struct game *game_create(void)
{
    ...
    game->base_item_info[BASE_ITEM_BATTLEAXE].damage = DAMAGE_SLASHING;
    ...
    game->base_item_info[BASE_ITEM_BATTLEAXE].base_ac = 0;
    ...
    game->base_item_info[BASE_ITEM_CLUB].damage = DAMAGE_BLUDGEONING;
    ...
    game->base_item_info[BASE_ITEM_CLUB].base_ac = 0;
    ...
    game->base_item_info[BASE_ITEM_DAGGER].damage = DAMAGE_PIERCING;
    ...
    game->base_item_info[BASE_ITEM_DAGGER].base_ac = 0;
    ...
    game->base_item_info[BASE_ITEM_GREATAXE].damage = DAMAGE_SLASHING;
    ...
    game->base_item_info[BASE_ITEM_GREATAXE].base_ac = 0;
    ...
    game->base_item_info[BASE_ITEM_GREATSWORD].damage = DAMAGE_SLASHING;
    ...
    game->base_item_info[BASE_ITEM_GREATSWORD].base_ac = 0;
    ...
    game->base_item_info[BASE_ITEM_HALBERD].damage = DAMAGE_PIERCING;
    ...
    game->base_item_info[BASE_ITEM_HALBERD].base_ac = 0;
    ...
    game->base_item_info[BASE_ITEM_HEAVY_CROSSBOW].damage = DAMAGE_PIERCING;
    ...
    game->base_item_info[BASE_ITEM_HEAVY_CROSSBOW].base_ac = 0;
    ...
    game->base_item_info[BASE_ITEM_KATANA].damage = DAMAGE_SLASHING;
    ...
    game->base_item_info[BASE_ITEM_KATANA].base_ac = 0;
    ...
    game->base_item_info[BASE_ITEM_LARGE_SHIELD].damage = 0;
    ...
    game->base_item_info[BASE_ITEM_LARGE_SHIELD].base_ac = 2;
    ...
    game->base_item_info[BASE_ITEM_LIGHT_CROSSBOW].damage = DAMAGE_PIERCING;
    ...
    game->base_item_info[BASE_ITEM_LIGHT_CROSSBOW].base_ac = 0;
    ...
    game->base_item_info[BASE_ITEM_LONGBOW].damage = DAMAGE_PIERCING;
    ...
    game->base_item_info[BASE_ITEM_LONGBOW].base_ac = 0;
    ...
    game->base_item_info[BASE_ITEM_LONGSWORD].damage = DAMAGE_SLASHING;
    ...
    game->base_item_info[BASE_ITEM_LONGSWORD].base_ac = 0;
    ...
    game->base_item_info[BASE_ITEM_MACE].damage = DAMAGE_BLUDGEONING;
    ...
    game->base_item_info[BASE_ITEM_QUARTERSTAFF].damage = DAMAGE_BLUDGEONING;
    ...
    game->base_item_info[BASE_ITEM_QUARTERSTAFF].base_ac = 0;
    ...
    game->base_item_info[BASE_ITEM_SCIMITAR].damage = DAMAGE_SLASHING;
    ...
    game->base_item_info[BASE_ITEM_SCIMITAR].base_ac = 0;
    ...
    game->base_item_info[BASE_ITEM_SHORTBOW].damage = DAMAGE_PIERCING;
    ...
    game->base_item_info[BASE_ITEM_SHORTBOW].base_ac = 0;
    ...
    game->base_item_info[BASE_ITEM_SHORTSWORD].damage = DAMAGE_PIERCING;
    ...
    game->base_item_info[BASE_ITEM_SHORTSWORD].base_ac = 0;
    ...
    game->base_item_info[BASE_ITEM_SMALL_SHIELD].damage = 0;
    ...
    game->base_item_info[BASE_ITEM_SMALL_SHIELD].base_ac = 1;
    ...
    game->base_item_info[BASE_ITEM_SPEAR].damage = DAMAGE_PIERCING;
    ...
    game->base_item_info[BASE_ITEM_SPEAR].base_ac = 0;
    ...
    game->base_item_info[BASE_ITEM_TOWER_SHIELD].damage = 0;
    ...
    game->base_item_info[BASE_ITEM_TOWER_SHIELD].base_ac = 3;
    ...
    game->base_item_info[BASE_ITEM_WARHAMMER].damage = DAMAGE_BLUDGEONING;
    ...
    game->base_item_info[BASE_ITEM_WARHAMMER].base_ac = 0;
    ...
    game->item_property_info[ITEM_PROPERTY_AC_SHIELD_1].text = "Armor Bonus: +1 (AC Shield Modifier)";
    game->item_property_info[ITEM_PROPERTY_AC_SHIELD_1].enhancement_bonus = 0;
    game->item_property_info[ITEM_PROPERTY_AC_SHIELD_1].ac = AC_SHIELD;
    game->item_property_info[ITEM_PROPERTY_AC_SHIELD_1].ac_bonus = 1;
    game->item_property_info[ITEM_PROPERTY_ENHANCEMENT_BONUS_1].text = "Enhancement Bonus: +1";
    game->item_property_info[ITEM_PROPERTY_ENHANCEMENT_BONUS_1].enhancement_bonus = 1;
    game->item_property_info[ITEM_PROPERTY_ENHANCEMENT_BONUS_1].ac = 0;
    game->item_property_info[ITEM_PROPERTY_ENHANCEMENT_BONUS_1].ac_bonus = 0;

    game->item_info[ITEM_TYPE_BATTLEAXE].base_item = BASE_ITEM_BATTLEAXE;
    game->item_info[ITEM_TYPE_BATTLEAXE].name = "Battleaxe";
    game->item_info[ITEM_TYPE_BATTLEAXE].description = "A generic battleaxe.";
    game->item_info[ITEM_TYPE_BATTLEAXE_1].base_item = BASE_ITEM_BATTLEAXE;
    game->item_info[ITEM_TYPE_BATTLEAXE_1].name = "Battleaxe + 1";
    game->item_info[ITEM_TYPE_BATTLEAXE_1].description = "A special battleaxe.";
    game->item_info[ITEM_TYPE_BATTLEAXE_1].item_properties[ITEM_PROPERTY_ENHANCEMENT_BONUS_1] = true;
    game->item_info[ITEM_TYPE_CLUB].base_item = BASE_ITEM_CLUB;
    game->item_info[ITEM_TYPE_CLUB].name = "Club";
    game->item_info[ITEM_TYPE_CLUB].description = "A generic club.";
    game->item_info[ITEM_TYPE_CLUB_1].base_item = BASE_ITEM_CLUB;
    game->item_info[ITEM_TYPE_CLUB_1].name = "Club + 1";
    game->item_info[ITEM_TYPE_CLUB_1].description = "A special club.";
    game->item_info[ITEM_TYPE_CLUB_1].item_properties[ITEM_PROPERTY_ENHANCEMENT_BONUS_1] = true;
    game->item_info[ITEM_TYPE_DAGGER].base_item = BASE_ITEM_DAGGER;
    game->item_info[ITEM_TYPE_DAGGER].name = "Dagger";
    game->item_info[ITEM_TYPE_DAGGER].description = "A generic dagger.";
    game->item_info[ITEM_TYPE_DAGGER_1].base_item = BASE_ITEM_DAGGER;
    game->item_info[ITEM_TYPE_DAGGER_1].name = "Dagger + 1";
    game->item_info[ITEM_TYPE_DAGGER_1].description = "A special dagger.";
    game->item_info[ITEM_TYPE_DAGGER_1].item_properties[ITEM_PROPERTY_ENHANCEMENT_BONUS_1] = true;
    game->item_info[ITEM_TYPE_GREATAXE].base_item = BASE_ITEM_GREATAXE;
    game->item_info[ITEM_TYPE_GREATAXE].name = "Greataxe";
    game->item_info[ITEM_TYPE_GREATAXE].description = "A generic greataxe.";
    game->item_info[ITEM_TYPE_GREATAXE_1].base_item = BASE_ITEM_GREATAXE;
    ...
    game->item_info[ITEM_TYPE_HALBERD_1].base_item = BASE_ITEM_HALBERD;
    game->item_info[ITEM_TYPE_HALBERD_1].name = "Halberd + 1";
    game->item_info[ITEM_TYPE_HALBERD_1].description = "A special halberd.";
    game->item_info[ITEM_TYPE_HALBERD_1].item_properties[ITEM_PROPERTY_ENHANCEMENT_BONUS_1] = true;
    game->item_info[ITEM_TYPE_HEAVY_CROSSBOW].base_item = BASE_ITEM_HEAVY_CROSSBOW;
    game->item_info[ITEM_TYPE_HEAVY_CROSSBOW].name = "Heavy Crossbow";
    game->item_info[ITEM_TYPE_HEAVY_CROSSBOW].description = "A generic heavy crossbow.";
    game->item_info[ITEM_TYPE_HEAVY_CROSSBOW_1].base_item = BASE_ITEM_HEAVY_CROSSBOW;
    game->item_info[ITEM_TYPE_HEAVY_CROSSBOW_1].name = "Heavy Crossbow + 1";
    game->item_info[ITEM_TYPE_HEAVY_CROSSBOW_1].description = "A special heavy crossbow.";
    game->item_info[ITEM_TYPE_HEAVY_CROSSBOW_1].item_properties[ITEM_PROPERTY_ENHANCEMENT_BONUS_1] = true;
    game->item_info[ITEM_TYPE_KATANA].base_item = BASE_ITEM_KATANA;
    game->item_info[ITEM_TYPE_KATANA].name = "Katana";
    game->item_info[ITEM_TYPE_KATANA].description = "A generic katana.";
    game->item_info[ITEM_TYPE_KATANA_1].base_item = BASE_ITEM_KATANA;
    game->item_info[ITEM_TYPE_KATANA_1].name = "Katana + 1";
    game->item_info[ITEM_TYPE_KATANA_1].description = "A special katana.";
    game->item_info[ITEM_TYPE_KATANA_1].item_properties[ITEM_PROPERTY_ENHANCEMENT_BONUS_1] = true;
    game->item_info[ITEM_TYPE_LARGE_SHIELD].base_item = BASE_ITEM_LARGE_SHIELD;
    game->item_info[ITEM_TYPE_LARGE_SHIELD].name = "Large Shield";
    game->item_info[ITEM_TYPE_LARGE_SHIELD].description = "A generic large shield.";
    game->item_info[ITEM_TYPE_LARGE_SHIELD_1].base_item = BASE_ITEM_LARGE_SHIELD;
    game->item_info[ITEM_TYPE_LARGE_SHIELD_1].name = "Large Shield + 1";
    game->item_info[ITEM_TYPE_LARGE_SHIELD_1].description = "A special large shield.";
    game->item_info[ITEM_TYPE_LARGE_SHIELD_1].item_properties[ITEM_PROPERTY_AC_SHIELD_1] = true;
    game->item_info[ITEM_TYPE_LIGHT_CROSSBOW].base_item = BASE_ITEM_LIGHT_CROSSBOW;
    game->item_info[ITEM_TYPE_LIGHT_CROSSBOW].name = "Light Crossbow";
    game->item_info[ITEM_TYPE_LIGHT_CROSSBOW].description = "A generic light crossbow.";
    game->item_info[ITEM_TYPE_LIGHT_CROSSBOW_1].base_item = BASE_ITEM_LIGHT_CROSSBOW;
    game->item_info[ITEM_TYPE_LIGHT_CROSSBOW_1].name = "Light Crossbow + 1";
    game->item_info[ITEM_TYPE_LIGHT_CROSSBOW_1].description = "A special light crossbow.";
    game->item_info[ITEM_TYPE_LIGHT_CROSSBOW_1].item_properties[ITEM_PROPERTY_ENHANCEMENT_BONUS_1] = true;
    game->item_info[ITEM_TYPE_LONGBOW].base_item = BASE_ITEM_LONGBOW;
    game->item_info[ITEM_TYPE_LONGBOW].name = "Longbow";
    game->item_info[ITEM_TYPE_LONGBOW].description = "A generic longbow.";
    game->item_info[ITEM_TYPE_LONGBOW_1].base_item = BASE_ITEM_LONGBOW;
    game->item_info[ITEM_TYPE_LONGBOW_1].name = "Longbow + 1";
    game->item_info[ITEM_TYPE_LONGBOW_1].description = "A special longbow.";
    game->item_info[ITEM_TYPE_LONGBOW_1].item_properties[ITEM_PROPERTY_ENHANCEMENT_BONUS_1] = true;
    game->item_info[ITEM_TYPE_LONGSWORD].base_item = BASE_ITEM_LONGSWORD;
    game->item_info[ITEM_TYPE_LONGSWORD].name = "Longsword";
    game->item_info[ITEM_TYPE_LONGSWORD].description = "A generic longsword.";
    game->item_info[ITEM_TYPE_LONGSWORD_1].base_item = BASE_ITEM_LONGSWORD;
    game->item_info[ITEM_TYPE_LONGSWORD_1].name = "Longsword + 1";
    game->item_info[ITEM_TYPE_LONGSWORD_1].description = "A special longsword.";
    game->item_info[ITEM_TYPE_LONGSWORD_1].item_properties[ITEM_PROPERTY_ENHANCEMENT_BONUS_1] = true;
    game->item_info[ITEM_TYPE_MACE].base_item = BASE_ITEM_MACE;
    game->item_info[ITEM_TYPE_MACE].name = "Mace";
    game->item_info[ITEM_TYPE_MACE].description = "A generic mace.";
    game->item_info[ITEM_TYPE_MACE_1].base_item = BASE_ITEM_MACE;
    ...
    game->item_info[ITEM_TYPE_QUARTERSTAFF_1].base_item = BASE_ITEM_QUARTERSTAFF;
    game->item_info[ITEM_TYPE_QUARTERSTAFF_1].name = "Quarterstaff + 1";
    game->item_info[ITEM_TYPE_QUARTERSTAFF_1].description = "A special quarterstaff.";
    game->item_info[ITEM_TYPE_QUARTERSTAFF_1].item_properties[ITEM_PROPERTY_ENHANCEMENT_BONUS_1] = true;
    game->item_info[ITEM_TYPE_SCIMITAR].base_item = BASE_ITEM_SCIMITAR;
    game->item_info[ITEM_TYPE_SCIMITAR].name = "Scimitar";
    game->item_info[ITEM_TYPE_SCIMITAR].description = "A generic scimitar.";
    game->item_info[ITEM_TYPE_SCIMITAR_1].base_item = BASE_ITEM_SCIMITAR;
    game->item_info[ITEM_TYPE_SCIMITAR_1].name = "Scimitar + 1";
    game->item_info[ITEM_TYPE_SCIMITAR_1].description = "A special scimitar.";
    game->item_info[ITEM_TYPE_SCIMITAR_1].item_properties[ITEM_PROPERTY_ENHANCEMENT_BONUS_1] = true;
    game->item_info[ITEM_TYPE_SHORTBOW].base_item = BASE_ITEM_SHORTBOW;
    game->item_info[ITEM_TYPE_SHORTBOW].name = "Shortbow";
    game->item_info[ITEM_TYPE_SHORTBOW].description = "A generic shortbow.";
    game->item_info[ITEM_TYPE_SHORTBOW_1].base_item = BASE_ITEM_SHORTBOW;
    game->item_info[ITEM_TYPE_SHORTBOW_1].name = "Shortbow + 1";
    game->item_info[ITEM_TYPE_SHORTBOW_1].description = "A special shortbow.";
    game->item_info[ITEM_TYPE_SHORTBOW_1].item_properties[ITEM_PROPERTY_ENHANCEMENT_BONUS_1] = true;
    game->item_info[ITEM_TYPE_SHORTSWORD].base_item = BASE_ITEM_SHORTSWORD;
    game->item_info[ITEM_TYPE_SHORTSWORD].name = "Shortsword";
    game->item_info[ITEM_TYPE_SHORTSWORD].description = "A generic shortsword.";
    game->item_info[ITEM_TYPE_SHORTSWORD_1].base_item = BASE_ITEM_SHORTSWORD;
    game->item_info[ITEM_TYPE_SHORTSWORD_1].name = "Shortsword + 1";
    game->item_info[ITEM_TYPE_SHORTSWORD_1].description = "A special shortsword.";
    game->item_info[ITEM_TYPE_SHORTSWORD_1].item_properties[ITEM_PROPERTY_ENHANCEMENT_BONUS_1] = true;
    game->item_info[ITEM_TYPE_SMALL_SHIELD].base_item = BASE_ITEM_SMALL_SHIELD;
    game->item_info[ITEM_TYPE_SMALL_SHIELD].name = "Small Shield";
    game->item_info[ITEM_TYPE_SMALL_SHIELD].description = "A generic small shield.";
    game->item_info[ITEM_TYPE_SMALL_SHIELD_1].base_item = BASE_ITEM_SMALL_SHIELD;
    game->item_info[ITEM_TYPE_SMALL_SHIELD_1].name = "Small Shield + 1";
    game->item_info[ITEM_TYPE_SMALL_SHIELD_1].description = "A special small shield.";
    game->item_info[ITEM_TYPE_SMALL_SHIELD_1].item_properties[ITEM_PROPERTY_AC_SHIELD_1] = true;
    game->item_info[ITEM_TYPE_SPEAR].base_item = BASE_ITEM_SPEAR;
    game->item_info[ITEM_TYPE_SPEAR].name = "Spear";
    game->item_info[ITEM_TYPE_SPEAR].description = "A generic spear.";
    game->item_info[ITEM_TYPE_SPEAR_1].base_item = BASE_ITEM_SPEAR;
    game->item_info[ITEM_TYPE_SPEAR_1].name = "Spear + 1";
    game->item_info[ITEM_TYPE_SPEAR_1].description = "A special spear.";
    game->item_info[ITEM_TYPE_SPEAR_1].item_properties[ITEM_PROPERTY_ENHANCEMENT_BONUS_1] = true;
    game->item_info[ITEM_TYPE_TOWER_SHIELD].base_item = BASE_ITEM_TOWER_SHIELD;
    game->item_info[ITEM_TYPE_TOWER_SHIELD].name = "Tower Shield";
    game->item_info[ITEM_TYPE_TOWER_SHIELD].description = "A generic tower shield.";
    game->item_info[ITEM_TYPE_TOWER_SHIELD_1].base_item = BASE_ITEM_TOWER_SHIELD;
    game->item_info[ITEM_TYPE_TOWER_SHIELD_1].name = "Tower Shield + 1";
    game->item_info[ITEM_TYPE_TOWER_SHIELD_1].description = "A special tower shield.";
    game->item_info[ITEM_TYPE_TOWER_SHIELD_1].item_properties[ITEM_PROPERTY_AC_SHIELD_1] = true;
    game->item_info[ITEM_TYPE_WARHAMMER].base_item = BASE_ITEM_WARHAMMER;
    game->item_info[ITEM_TYPE_WARHAMMER].name = "Warhammer";
    game->item_info[ITEM_TYPE_WARHAMMER].description = "A generic warhammer.";
    game->item_info[ITEM_TYPE_WARHAMMER_1].base_item = BASE_ITEM_WARHAMMER;
    game->item_info[ITEM_TYPE_WARHAMMER_1].name = "Warhammer + 1";
    game->item_info[ITEM_TYPE_WARHAMMER_1].description = "A special warhammer.";
    game->item_info[ITEM_TYPE_WARHAMMER_1].item_properties[ITEM_PROPERTY_ENHANCEMENT_BONUS_1] = true;
